...
const Navbar = () => {
  ...
  <Link to="/cart" role="button" className="relative flex">
    <svg className="flex-1 w-8 h-8 fill-current" viewBox="0 0 24 24">
      ...
      <span className="absolute right-0 top-0 rounded-full bg-[#40AA54] w-4 h-4 top right p-0 m-0 text-white font-mono text-sm  leading-tight text-center">5
    </span></Link>
      ...
      <ul className={nav ? ' flex flex-col items-center fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300'}>
        ...
        <li className='p-4 hover:text-[#40AA54] text-[#16162E] active:text-[#40AA54] transition duration-500'><Link to="/">Home</Link></li>
        <li className='p-4 hover:text-[#40AA54]  text-[#16162E] active:text-[#40AA54] transition duration-500'><Link to="/products">Products</Link></li>
        <li className='p-4 hover:text-[#40AA54]  text-[#16162E] active:text-[#40AA54] transition duration-500'>About</li>
